defmodule ElixirStatus.ImpressionTest do
  ...
  @valid_attrs %{path: "/", accept_language: "some content", context: "frontpage", current_user_id: 1234, remote_ip: "127.0.0.1", session_hash: "some content", subject_type: "posting", subject_uid: "a2d1", user_agent: "some content"}
  @invalid_attrs %{}
